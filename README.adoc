= Ribose open documents

//image:https://github.com/metanorma/mn-samples-itu/workflows/publish/badge.svg["Build Status", link="https://github.com/metanorma/mn-samples-itu/actions?workflow=publish"]
